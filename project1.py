...
def calc(op) :
    ...
    if op =="+" :
        ...
        label_result_text.set("Result :" + str(round(div)))

    elif op =="x" :
        mul = float(entry_x.get()) * float(entry_y.get())
        label_result_text.set("Result :" + str(round(mul)))

    elif op =="%" :
        rem = float(entry_x.get()) % float(entry_y.get())
        label_result_text.set("Result :" + str(round(rem)))

    elif op =="^" :
        power = float(entry_x.get()) ** float(entry_y.get())
        label_result_text.set("Result :" + str(round(power)))
